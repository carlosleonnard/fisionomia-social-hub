...
const ANCESTRY_OPTIONS = [
  ...
  'Haitian', 'Honduran', 'Hungarian', 'Icelander', 'Indian', 'Indonesian', 'Iranian',
  'Iraqi', 'Irish', 'Israeli', 'Italian', 'Jamaican', 'Japanese', 'Jordanian', 'Kazakh',
  'Kenyan', 'I-Kiribati', 'North Korean', 'South Korean', 'Kuwaiti', 'Kyrgyz', 'Laotian',
  ...
  'Monegasque', 'Mongolian', 'Montenegrin', 'Moroccan', 'Mozambican', 'Burmese',
