...
const Index = () => {
  ...
  const [celebrityProfiles] = useState<Profile[]>([
    ...
    },
    {
      ...
      phenotypes: ["Nordic", "Germanic"],
      likes: 3892,
      votes: [
        { classification: "Nordic", count: 2335, percentage: 60 },
        { classification: "Germanic", count: 1557, percentage: 40 }
      ],
      hasUserVoted: false,
      comments: []
    },
    {
      ...
      phenotypes: ["Sub-Saharan African", "West African"],
      likes: 2784,
      votes: [
        { classification: "Sub-Saharan African", count: 1670, percentage: 60 },
        { classification: "West African", count: 1114, percentage: 40 }
      ],
      hasUserVoted: false,
      comments: []
    },
    {
      ...
      imageUrl: "https://images.unsplash.com/photo-1554151228-14d9def656e4?w=400&h=400&fit=crop&crop=face",
      phenotypes: ["Mediterranean", "Iberian"],
      likes: 2156,
      votes: [
        { classification: "Mediterranean", count: 1294, percentage: 60 },
        { classification: "Iberian", count: 862, percentage: 40 }
      ],
      hasUserVoted: false,
      comments: []
    },
    {
      ...
      phenotypes: ["Anglo-Saxon", "Celtic"],
      likes: 3627,
      votes: [
        { classification: "Anglo-Saxon", count: 2176, percentage: 60 },
        { classification: "Celtic", count: 1451, percentage: 40 }
      ],
      hasUserVoted: false,
      comments: []
    },
    {
      ...
      likes: 4156,
      votes: [
        { classification: "Anglo-Saxon", count: 2494, percentage: 60 },
        { classification: "Celtic", count: 1662, percentage: 40 }
      ],
      hasUserVoted: false,
      comments: []
    },
    {
      ...
      phenotypes: ["Indo-Aryan", "Gujarati"],
      likes: 1923,
      votes: [
        { classification: "Indo-Aryan", count: 1154, percentage: 60 },
        { classification: "Gujarati", count: 769, percentage: 40 }
      ],
      hasUserVoted: false,
      comments: []
    }
