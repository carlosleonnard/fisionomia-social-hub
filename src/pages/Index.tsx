          ...
          <div className="bg-slate-100">
                  ...
                  <Carousel className="w-full" opts={{ align: "start", loop: false }}>
                    <div className="relative group">
                     <CarouselContent className="ml-0">
                      {(userProfiles?.filter(profile => !profile.is_anonymous) || []).map((profile, index) => (
            ...
            <div className="mb-12">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
                {(profilesByVotes || []).slice(0, 12).map((profile, index) => (
                    ...
                    >
                      <div className="flex flex-col items-center p-3 rounded-lg hover:bg-accent/50 transition-colors">
                        <div className="relative mb-3">
                          <div className="w-28 h-28 rounded-full overflow-hidden border-2 border-primary p-1 cursor-pointer bg-primary/10">
                            <img 
                              src={profile.front_image_url} 
                              alt={profile.name}
                              className="w-full h-full rounded-full object-cover"
                          ...
                          {index < 3 && (
                            <div className="absolute -top-2 left-1/2 -translate-x-1/2 bg-yellow-500 text-white text-xs px-2 py-1 rounded-full">
                              #{index + 1}
                            </div>
                          )}
                        </div>
